...
struct Host
{
	...
	static Payload 				payload_from_ascii(const std::string ascii_text);
	static Payload			 	payload_from_hex(const std::string hex_data);
	static Payload			 	random_hex(int bytes);
