...
public:
	...
	Payload(const Byte byte, const size_t bytes=0);
	//Payload(const std::vector<Byte>& byte_vec);
	Payload(const std::vector<Byte>& byte_vec, const size_t bytes=0);
	...
	//void next(Byte byte);
	void next(const Byte byte, const size_t bytes=0);
	//void next(const std::vector<Byte>& vec);
	void next(const std::vector<Byte>& vec, const size_t bytes=0);
	void next(const std::string& str, const size_t bytes=0, const bool ascii=false);
	//void next(const Payload &payload);
	void next(const Payload &payload, const size_t bytes=0);
	...
	Payload get_payload(const long unsigned int size) const;

	//template <typename T>
	//T get(const long unsigned int beg, const long unsigned int size) const;
	
	int get_int(const long unsigned int beg, const long unsigned int size) const;

	//template <typename T>
	//T get(const long unsigned int size) const;
	//
	int get_int(const long unsigned int size) const;
